...
- **Settlement-communication framing** — research the settlement-communication protections applicable in the forum (《民事诉讼法》及相关司法解释中关于调解保密的规定). Note whether the demand is marked as a settlement communication, but remember: protection attaches from conduct and context, not merely from labeling. Capture both the label (if any) and a first-pass read of whether the substance is in fact a compromise discussion.
...
- Tradeoff: settlement-communication posture required — research the applicable rule (《民事诉讼法》及相关司法解释) and structure the response so the substance, not just the label, qualifies as a compromise discussion. Must be careful not to waive claims.
